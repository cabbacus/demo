...
require get_parent_theme_file_path( '/inc/merlin/vendor/autoload.php' );

if ( is_admin() ) {
	require get_parent_theme_file_path( '/inc/merlin/class-merlin.php' );
	require get_parent_theme_file_path( '/inc/merlin/includes/wizard-config.php' );
}
...
if ( ! function_exists('barberry_theme_styles') ) :
	...
	function barberry_theme_styles () {
			...
			wp_register_style( 'stylesheet', get_stylesheet_uri(), array(), barberry_theme_version(), 'all' );
			wp_register_style( 'barberry-icon-font', get_template_directory_uri() .  "/css/theme-icons.css", NULL, barberry_theme_version(), 'all');
			wp_register_style( 'barberry-app', get_template_directory_uri() .  "/css/app.css", array(), barberry_theme_version(), null);
			wp_register_style( 'barberry-app-min', get_template_directory_uri() .  "/css/app-min.css", array(), barberry_theme_version(), null);

			wp_enqueue_style('barberry-icon-font');

			if ( TDL_Opt::getOption('minified_css') ) {
				wp_enqueue_style('barberry-app-min');	
			} else 	{
...
if ( ! function_exists( 'barberry_enqueue_script' ) ) {
	function barberry_enqueue_script( $script_name ) {
...
if( ! function_exists( 'barberry_get_script_url') ) {
	function barberry_get_script_url( $script_name ) {
	    return BARBERRY_SCRIPTS . '/assets/vendor/plugins/' . $script_name . '.js';
	}
}
...
function barberry_scripts_header_priority_0() {
	...
	$version = barberry_theme_version( 'Version' );

	if ( TDL_Opt::getOption('page_loader') ) {
		wp_enqueue_script('barberry-nprogress', barberry_get_script_url( 'nprogress-min' ), NULL, $version, FALSE);
	}
...
if ( TDL_Opt::getOption('combined_js') ) {
	...
	wp_enqueue_script('barberry-plugins', get_template_directory_uri() . '/js/barberry-plugins-ext.js', $dependencies, $version, true);

	if ( TDL_Opt::getOption('shop_countdown') || TDL_Opt::getOption('product_countdown') || TDL_Opt::getOption('sale_countdown_variable')) {
		wp_enqueue_script('barberry-countdown', barberry_get_script_url( 'countdown-min' ), $dependencies, $version, true);
	}
	...
	wp_enqueue_script('jquery-visible', barberry_get_script_url( 'jquery.visible-min' ), $dependencies, $version, true);
	wp_enqueue_script('jquery-cookie', barberry_get_script_url( 'jquery.cookie-min' ), $dependencies, $version, true);
	wp_enqueue_script('sticky-header', barberry_get_script_url( 'headhesive-min' ), $dependencies, $version, true);
	wp_enqueue_script('foundation', barberry_get_script_url( 'foundation-min' ), $dependencies, $version, true);
	wp_enqueue_script('lazyload', barberry_get_script_url( 'lazyload-min' ), $dependencies, $version, true);
	wp_enqueue_script('jquery-hoverintent', barberry_get_script_url( 'hoverintent-min' ), $dependencies, $version, true);
	wp_enqueue_script('jquery-nanoscroller', barberry_get_script_url( 'jquery.nanoscroller-min' ), $dependencies, $version, true);
	wp_enqueue_script('imagesloaded', barberry_get_script_url( 'imagesloaded.pkgd-min' ), $dependencies, $version, true);
	wp_enqueue_script('flickity', barberry_get_script_url( 'flickity.pkgd-min' ), $dependencies, $version, true);
	wp_enqueue_script('flickity-sync', barberry_get_script_url( 'flickity-sync-min' ), $dependencies, $version, true);
	wp_enqueue_script('flickity-bg-lazyload', barberry_get_script_url( 'bg-lazyload-min' ), $dependencies, $version, true);
	wp_enqueue_script('rellax', barberry_get_script_url( 'rellax-min' ), $dependencies, $version, true);
	wp_enqueue_script('parallax-scroll', barberry_get_script_url( 'jquery.parallax-scroll-min' ), $dependencies, $version, true);
	wp_enqueue_script('mobile-detect', barberry_get_script_url( 'mobile-detect-min' ), $dependencies, $version, true);

	if ( TDL_Opt::getOption('typewriter_effect')) {
		wp_enqueue_script('typed', barberry_get_script_url( 'typed-min' ), $dependencies, $version, true);
	}

	wp_enqueue_script('gsap', barberry_get_script_url( 'gsap-min' ), $dependencies, $version, true);
	wp_enqueue_script('splittext', barberry_get_script_url( 'splittext-min' ), $dependencies, $version, true);
	wp_enqueue_script('scrollreveal', barberry_get_script_url( 'scrollreveal-min' ), $dependencies, $version, true);
	wp_enqueue_script('resizesensor', barberry_get_script_url( 'ResizeSensor-min' ), $dependencies, $version, true);
	wp_enqueue_script('sticky-sidebar', barberry_get_script_url( 'theia-sticky-sidebar-min' ), $dependencies, $version, true);
	wp_enqueue_script('jquery-zoom', barberry_get_script_url( 'jquery.zoom-min' ), $dependencies, $version, true);
	wp_enqueue_script('color-thief', barberry_get_script_url( 'color-thief-min' ), $dependencies, $version, true);
	wp_enqueue_script('photoswipe', barberry_get_script_url( 'photoswipe-min' ), $dependencies, $version, true);
	wp_enqueue_script('photoswipe-ui', barberry_get_script_url( 'photoswipe-ui-default-min' ), $dependencies, $version, true);

	if ( TDL_Opt::getOption('product_share') || TDL_Opt::getOption('blog_single_share')) {
		wp_enqueue_script('barberry-social-share', barberry_get_script_url( 'social-share-min' ), $dependencies, $version, true);
	}
	
	wp_enqueue_script('countdown', barberry_get_script_url( 'countdown-min' ), $dependencies, $version, true);
	wp_enqueue_script('autocomplete', barberry_get_script_url( 'jquery.autocomplete-min' ), $dependencies, $version, true);
	}

	if ( TDL_Opt::getOption('minified_js') ) {
		wp_enqueue_script('barberry-scripts', get_template_directory_uri() . '/js/barberry-scripts-ext.min.js', $dependencies, $version, true);
	} else 	{
		wp_enqueue_script('barberry-scripts', get_template_directory_uri() . '/js/barberry-scripts-ext.js', $dependencies, $version, true);
	}
