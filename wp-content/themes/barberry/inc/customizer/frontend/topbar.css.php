<style>
	...
	.topbar-wpml .barberry-switcher .dropdown.menu > li.is-dropdown-submenu-parent > a,
	.topbar-wpml .barberry-switcher .dropdown.menu > li.is-dropdown-submenu-parent > a::after,
	.topbar-wpml .language_currency_switcher .language_switcher nav > ul > li > a span,
	.topbar-wpml .language_currency_switcher .currency_switcher nav > ul > li > a span,
	.topbar-wpml .language_currency_switcher .language_switcher nav ul.is-dropdown-submenu li a span,
	.topbar-wpml .language_currency_switcher .currency_switcher nav ul.is-dropdown-submenu li a span,
	.topbar-wpml .language_currency_switcher .language_switcher nav ul.is-dropdown-submenu li a,
	.topbar-wpml .language_currency_switcher .currency_switcher nav ul.is-dropdown-submenu li a {
		color: <?php echo esc_html(TDL_Opt::getOption('topbar_font_color')) ?>;
	}
