<style>
	...
	.widget .widget-title,
	.widget .wc-block-product-categories .wc-block-product-categories-list:not(.wc-block-product-categories-list--depth-1) li > a,
	...
	?>
		...
		h4, h4 a, .woocommerce h4, .woocommerce-page h4, .widget.widget_block .wp-block-group__inner-container > h2, .widget.widget_block .widgettitle  { font-size: <?php echo esc_attr($h4_size); ?>px; }
	...
	@media screen and (max-width: 64em) {
		...
		h4, h4 a, .woocommerce h4, .woocommerce-page h4, .widget.widget_block .wp-block-group__inner-container > h2, .widget.widget_block .widgettitle  { font-size: <?php echo esc_attr($h4_size_medium); ?>px; }
	...
	@media screen and (max-width: 47.9375em) {
		...
		h4, h3 a, .woocommerce h4, .woocommerce-page h4, .widget.widget_block .wp-block-group__inner-container > h2, .widget.widget_block .widgettitle  { font-size: <?php echo esc_attr($h4_size_mobile); ?>px; }
