<style>
	...
	$footer_layout = (!empty(TDL_Opt::getOption('footer_layout'))) ? TDL_Opt::getOption('footer_layout') : 4;
	$footer_copy_section = (!empty(TDL_Opt::getOption('footer_copy_section'))) ? TDL_Opt::getOption('footer_copy_section') : 1;
