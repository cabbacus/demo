<style>
	...
	.widget .wc-block-product-categories .wc-block-product-categories-list li > a,
	.widget .wc-block-product-categories .wc-block-product-categories-list li a:hover,
	.widget .wc-block-product-categories .wc-block-product-categories-list li span.wc-block-product-categories-list-item-count,
	...
	.search-form:after, .woocommerce-product-search:after, .searchform:after, .wp-block-search:after, .wc-block-product-search form:after,
	.widget .wc-block-grid__products li a.wc-block-grid__product-link .wc-block-grid__product-title,
...
h3, h3 a, .woocommerce h3, .woocommerce-page h3 {
	...
	.widget.woocommerce.widget_product_tag_cloud .tagcloud .tag-cloud-link,
	body.tag-cloud-equal .widget.woocommerce.widget_product_tag_cloud.widget_tag_cloud .tag-cloud-link, body.tag-cloud-equal .widget.woocommerce.widget_product_tag_cloud .tagcloud .tag-cloud-link,
	.select2,
	.search-form, .woocommerce-product-search, .searchform, .wp-block-search, .wc-block-product-search form,
	...
	body.tag-cloud-equal .widget_tag_cloud.widget_tag_cloud .tag-cloud-link {
	...
	body.tag-cloud-equal .widget.woocommerce.widget_product_tag_cloud.widget_tag_cloud .tag-cloud-link:before, body.tag-cloud-equal .widget.woocommerce.widget_product_tag_cloud .tagcloud .tag-cloud-link:before,
	.nano > .nano-pane,
	...
	body.tag-cloud-equal .widget_tag_cloud.widget_tag_cloud .tag-cloud-link:before {
...
/*	input::placeholder, textarea::placeholder,*/
	...
	.widget .wc-block-product-categories .wc-block-product-categories__button svg {
		fill: <?php echo TDL_Opt::getOption('base_color_scheme') ?>;
	}
	...
	.search-form:before, .woocommerce-product-search:before, .searchform:before, .wp-block-search:before, .wc-block-product-search form:before,
	.widget.woocommerce.widget_price_filter .ui-slider .ui-slider-range,
	.widget.woocommerce.widget_layered_nav ul li:not(.chosen) a:hover:after,
	.widget.woocommerce.woocommerce-widget-layered-nav ul li:not(.chosen) a:hover:after,
	.widget.woocommerce.barberry-price-filter-list ul li:not(.chosen) a:hover:after,
	...
	body.tag-cloud-equal .widget_tag_cloud.widget_tag_cloud .tag-cloud-link:hover {
	...
	.widget .wc-block-product-categories .wc-block-product-categories__button:hover {
	...
	.offcanvas_search .search-results-wrapp .search-results-inner .autocomplete-suggestion .suggestion-inner-wrapper .suggestion-inner .suggestion-details-wrapper .price, .wc-block-grid__product-price.price {
	...
	<?php if ( !TDL_Opt::getOption('myaccount_icons') ) : ?>
	...
	<?php if ( TDL_Opt::getOption('shop_category_count') ) : ?>
		...
		.widget.woocommerce.woocommerce-widget-layered-nav ul li span.count,
		.widget.woocommerce.barberry-price-filter-list ul li span.count,
		ul.products.columns-3.category-grid-layout-2 li.product-category .category_wrapper .category_details .more-products,
		ul.products.columns-4.category-grid-layout-2 li.product-category .category_wrapper .category_details .more-products,
		ul.products.columns-5.category-grid-layout-2 li.product-category .category_wrapper .category_details .more-products {
			display:none;
		}		
	<?php endif; ?>


	<?php if ( (!empty(TDL_Opt::getOption('product_columns_mob'))) && (TDL_Opt::getOption('product_columns_mob') == 1) ) : ?>
