...
Kirki::add_section( 'shop_myaccount', array(
    'title'          => esc_attr__( 'My Account', 'barberry' ),
    'priority'       => 50,
    'capability'     => 'edit_theme_options',
    'panel'          => 'woocommerce'
) );
...
require_once( get_template_directory() . '/inc/customizer/backend/shop/myaccount.php');
