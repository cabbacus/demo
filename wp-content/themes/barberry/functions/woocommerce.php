...
class Barberry_WooCommerce {
	...
	function hooks() {
		...
		if ( TDL_Opt::getOption('shop_decimals') ) {
			add_filter( 'formatted_woocommerce_price', 'barberry_woo_decimal_price', 10, 5 );
		}
...
if ( barberry_woocommerce_installed() ) {
	...
	if ( ! function_exists( 'barberry_single_product_variations_clear_button' ) ) {
		/**
		 * Single product clear button
		 *
		 * @since 1.0.0
		 */
		function barberry_single_product_variations_clear_button() {
			?>
		...
		add_action( 'woocommerce_before_single_variation', 'barberry_single_product_variations_clear_button', 10 );
	...
	function add_compare_icon_in_product_card() {
        ...
        <a href="javascript:void(0);" class="button compare-link barberry_product_compare_button<?php echo esc_attr($barberry_compare) ? ' barberry-compare' : ''; ?>" data-prod="<?php echo (int) $productId; ?>" data-tip="<?php echo esc_attr($button_text); ?>" title="<?php echo esc_attr($button_text); ?>">
			<span class="tooltip">
	...
	//==============================================================================
	if( ! function_exists( 'barberry_woo_decimal_price' ) ) {
		function barberry_woo_decimal_price( $formatted_price, $price, $decimal_places, $decimal_separator, $thousand_separator ) {
